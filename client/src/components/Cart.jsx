...
import { Offcanvas, Accordion,Image, Button,OffcanvasBody, OffcanvasHeader, OffcanvasTitle } from "react-bootstrap";
    ...
    <>
      ...
      <Offcanvas show={show} onHide={handleClose} placement='end' backdrop='static'>
        <OffcanvasHeader>
            <OffcanvasTitle>
                <div>
                    <MdOutlineArrowBackIosNew onClick={handleClose} className="cursor"/>
                </div>
                <h1>
                    Cart
                </h1>
